...
from telegram_bot.misc.utils import can_delete_admin, get_next_pag


def start(is_admin: bool = False):
    result = InlineKeyboardBuilder()
    if is_admin is True:
        result.row(InlineKeyboardButton(text="👑 Админ панель",
                                        callback_data=Cb.Start.admin()))
