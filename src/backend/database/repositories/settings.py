...
from src.backend.database.converters import convert_com_sub_chats_model_to_dto
from src.backend.common.dto import (
    ComSubChatsCreate,
    ComSubChatsDTO,
    ComSubChatsUpdate,
)
from src.backend.database.interfaces.repositories.base import Repository
from src.backend.database.models import ComSubChats
