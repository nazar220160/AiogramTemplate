...
ADD_COM_CHAT = _("<b>Обязательная подписка</b>: <i>Добавление чата</i>\n\n"
                 "<i>Перешлите сообщение из канала который нужно добавить либо отправьте его ID</i>")

GET_COM_CHAT_NOT_FOUND = _("Чат не найден. Сначала добавьте бота в админы чата и повторите попытку!")
