...
from src.backend.bot.common.middlewares import register_middlewares
from src.backend.bot.utils.other import set_bot_commands
from src.backend.bot.routers import router
from src.backend.bot.utils.polling_manager import PollingManager

from src.backend.bot.core import (
    load_bot,
    load_dispatcher,
    load_storage,
)
